    ...
    const main = document.querySelector("main")
        ...
        main.innerHTML = `  
         <section class="pergunta">
            ...
            <div> <p>Questão ${pergunta} de 10 </p>

                <h2>${alterarSinais(quiz.questions[pergunta-1].question)}</h2></div>
            ...
            <section class="alternativas">
                <form action="">
                    <label for="alternativa_a">
                        <input type="radio" name="alternativa value="   ${alterarSinais(quiz.questions[pergunta-1].options[0])}" " id="alternativa_a">
